REQUERIMIENTOS. -XAMPP o WAMPP -postman -nodejs -GIT
...
1.b Una vez inicializado Apache y Mysql, necesitaremos instalar la DB del proyecto. Para ello utilizaremos el IDE tanto sea heidiSQL o el mismo phpmyadmin.
...
1.d Luego dirigirse a la seccion Importar, que se encuentra en la barra superior. Seleccionar el archivo "delilah.sql" donde se encuentra la base de dato a importar.
...
2.f Para iniciar el proyecto, debemos tener los modulos apache y mysql prendidos. y luego en la terminal del sistema operativo ubicado en la carpeta del proyecto "delilah_api" 
...
-Las consultas deben ser en "application/x-www-form-urlencoded"
-Utilizar preferentemente el auth que devuelve el login , es el webtoken que tendra todos los datos del usuario que creamos en el endpoint register y su rol.